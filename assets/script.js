const translations = {
  en: {
    ...
    'hero.text': 'I turn complex Unity systems into measurable improvements in loading, memory, frame time and build delivery across AA, midcore, casual and mobile RPG projects.',
    'hero.emailCta': 'Email',
