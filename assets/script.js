const translations = {
  en: {
    ...
    'projects.mahjongContribution': 'Implemented gameplay and UI flows, integrated localization, analytics and monetization SDKs, and supported release polish.',
    ...
    'projects.busyBrainContribution': 'Built gameplay and responsive UI flows, integrated production SDKs and supported release stabilization.',
    ...
    'projects.storeContribution': 'Implemented gameplay loops and UI, integrated platform services and supported production delivery.',
  ...
  ru: {
    ...
    'projects.mahjongContribution': 'Реализовал gameplay и UI flows, интегрировал локализацию, аналитику и SDK монетизации, участвовал в подготовке релизов.',
    'projects.busyBrainTag': 'Mobile casual',
    'projects.busyBrainText': 'Casual mobile-проект: production gameplay, UI flows, integrations и release-focused polish.',
    'projects.busyBrainContribution': 'Разрабатывал gameplay и адаптивные UI flows, интегрировал production SDK и участвовал в стабилизации релизов.',
    'projects.storeTag': 'Mobile simulator',
    'projects.storeText': 'Mobile simulator-проект: gameplay loops, UI, platform integrations и production delivery work.',
    'projects.storeContribution': 'Реализовал gameplay loops и UI, интегрировал платформенные сервисы и участвовал в production delivery.',
