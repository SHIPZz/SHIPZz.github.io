const translations = {
  en: {
    ...
    'impact.fpsMetric': 'Ability and AI execution stabilized',
    'impact.fpsTitle': 'Critical frame drops eliminated',
    'impact.fpsScope': 'Ability simulation: 15 → 110 FPS · Enemy turns: 1–5 → 80–100 FPS',
    ...
    'about.text2': 'Currently working on a large-scale AA Steam project in a 35-person team. Alongside game features, responsibilities include TeamCity-based Unity CI/CD, internal build distribution, QA automation and AI-assisted code review workflows integrated with GitHub, Discord and n8n.',
  ...
  ru: {
    ...
    'impact.fpsMetric': 'Стабилизировано выполнение абилок и AI',
    'impact.fpsTitle': 'Критические просадки кадров устранены',
    'impact.fpsScope': 'Симуляция абилок: 15 → 110 FPS · Ходы противника: 1–5 → 80–100 FPS',
    ...
    'about.text2': 'В настоящее время работает над крупным AA-проектом для Steam в команде из 35 человек. Помимо игровых систем, зона ответственности включает Unity CI/CD на базе TeamCity, внутреннюю дистрибуцию билдов, автоматизацию QA и AI-assisted code review с интеграциями GitHub, Discord и n8n.',
