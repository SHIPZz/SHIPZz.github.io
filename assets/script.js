const translations = {
  en: {
    ...
    'about.text1': 'Unity Developer with 5+ years of commercial experience across AA, midcore, hypercasual and casual projects. Focused on gameplay architecture, UI systems, performance optimization, Unity tooling and build automation.',
    'about.text2': 'Experience includes a large-scale AA Steam project developed in a 35-person team. Alongside game features, responsibilities include TeamCity-based Unity CI/CD, internal build distribution, QA automation and AI-assisted code review workflows integrated with GitHub, Discord and n8n.',
    'about.text3': 'Previously worked as a senior developer on a midcore client-server project in a 13-person team, with responsibility for most client-server systems.',
    ...
    'experience.currentItem5': 'Introduced n8n and AI-assisted automation for build distribution, code review and ClickUp workflows.',
    ...
    'experience.previousItem1': 'Delivered gameplay architecture, MVP-based UI and multiplayer client-server systems for a midcore mobile RPG.',
  ...
  ru: {
    ...
    'about.text1': 'Unity-разработчик с более чем 5 годами коммерческого опыта в AA, midcore, hypercasual и casual-проектах. Основные направления: архитектура gameplay, UI-системы, оптимизация производительности, Unity-инструменты и автоматизация сборок.',
    'about.text2': 'Опыт включает крупный AA-проект для Steam, разрабатываемый командой из 35 человек. Помимо игровых систем, зона ответственности включала Unity CI/CD на базе TeamCity, внутреннюю дистрибуцию билдов, автоматизацию QA и AI-assisted code review с интеграциями GitHub, Discord и n8n.',
    'about.text3': 'Ранее работал senior-разработчиком над midcore клиент-серверным проектом в команде из 13 человек и отвечал за большую часть клиент-серверных систем.',
    ...
    'experience.currentItem5': 'Внедрил n8n и AI-assisted workflows для дистрибуции билдов, code review и автоматизации процессов в ClickUp.',
    ...
    'experience.previousItem1': 'Реализовал gameplay-архитектуру, MVP-based UI и multiplayer клиент-серверные системы для midcore mobile RPG.',
