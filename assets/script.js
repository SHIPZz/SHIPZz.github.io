const translations = {
  en: {
    ...
    'metrics.platforms': 'mobile turn-based RPG and gameplay-heavy production projects',
    'metrics.mobile': 'turn-based gameplay, meta loops and UI-heavy systems',
  ...
  ru: {
    ...
    'metrics.platforms': 'mobile turn-based RPG и gameplay-heavy production-проекты',
    'metrics.mobile': 'turn-based gameplay, meta loops и UI-heavy systems',
