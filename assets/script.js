const translations = {
  en: {
    metaTitle: 'Kianan Ibrahimov - Senior Unity Developer / Build Automation',
    metaDescription: 'Kianan Ibrahimov - Senior Unity Developer / Build Automation portfolio.',
    metaShareDescription: 'Kianan Ibrahimov - Senior Unity Developer / Build Automation portfolio.',
    ...
    'impact.projectContext': 'Critical Shift',
    ...
    'impact.deliveryBefore': 'Manual build delivery',
    'impact.deliveryAfter': 'No manual steps',
  ...
  ru: {
    ...
    'impact.deliveryBefore': 'Ручная доставка билдов',
    'impact.deliveryAfter': 'Без ручных действий',
