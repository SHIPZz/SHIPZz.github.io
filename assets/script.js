const translations = {
  ...
  ru: {
    ...
    'hero.eyebrow': 'Senior Unity Developer',
    'hero.title': 'Kenan Ibragimov',
    'hero.text': 'Senior Unity Developer с опытом коммерческой разработки более 5 лет. Проектирую игровые, интерфейсные и мета-системы, занимаюсь оптимизацией производительности, рендерингом, внутренними инструментами и автоматизацией сборок для ПК, консолей и мобильных платформ.',
    'hero.emailCta': 'Почта',
    'hero.pdfCta': 'Скачать CV - EN',
    'hero.casesCta': 'Посмотреть кейсы',
    'impact.title': 'Измеримые результаты разработки',
    'impact.loadTitle': 'Время загрузки сцен сокращено до 51%',
    'impact.hubLabel': 'Хаб',
    ...
    'impact.memoryTitle': 'Потребление памяти снижено до 40%',
    ...
    'impact.fpsTitle': 'Устранены критические просадки FPS',
    ...
    'impact.sizeTitle': 'Размер сборки сокращён на 48%',
    'impact.sizeDelta': 'Готовая сборка',
    ...
    'impact.deliveryTitle': 'Публикация и распространение сборок автоматизированы',
    ...
    'cases.loadingTitle': 'Сократил загрузку зависимостей и отложил создание объектов мира',
    ...
    'cases.memoryLabel': 'Память и жизненный цикл',
    'cases.memoryTitle': 'Устранил удержание состояния миссий и дублирование контента',
    ...
    'cases.performanceLabel': 'Производительность боя и AI',
    'cases.performanceTitle': 'Устранил повторные расчёты и оптимизировал поиск пути',
    ...
    'cases.performanceSolution': 'Убрал повторные проходы, сократил количество поисков пути и заменил временные коллекции собственными потокобезопасными пулами.',
    ...
    'projects.title': 'Избранные проекты и применённые технологии',
    'projects.criticalTag': 'AA tactical RPG',
    'projects.criticalText': 'Тактическая AA RPG для Windows, Steam Deck и Xbox. Работал над игровой логикой, UI и мета-системами, рендерингом на URP, интеграциями SDK и автоматизацией сборок.',
    'projects.contributionTitle': 'Мой вклад',
    'projects.criticalContribution': 'Разрабатывал игровые, интерфейсные и мета-системы, оптимизировал производительность и Addressables, создавал функции рендеринга на URP и автоматизировал публикацию сборок.',
    'projects.forgeTag': 'Multiplayer midcore RPG',
    'projects.forgeText': 'Пошаговая многопользовательская мобильная RPG с клиент-серверной логикой, чатом, социальными функциями, заданиями, рейтингами и облачными сохранениями.',
    'projects.forgeContribution': 'Разработал игровую архитектуру, UI на основе MVP и клиент-серверные системы с использованием REST API, SignalR и WebSockets.',
    ...
    'projects.mahjongTag': 'Mobile puzzle',
    'projects.mahjongText': 'Мобильная головоломка с игровыми и интерфейсными сценариями, интеграциями SDK, локализацией и подготовкой релизов.',
    'projects.mahjongContribution': 'Разрабатывал игровую логику и UI, интегрировал локализацию, аналитику и SDK монетизации, готовил релизные сборки.',
    'projects.busyBrainTag': 'Mobile casual',
    'projects.busyBrainText': 'Казуальная мобильная игра с игровой логикой, адаптивными интерфейсами и платформенными интеграциями.',
    ...
    'projects.storeTag': 'Mobile simulator',
    'projects.storeText': 'Мобильный симулятор с игровыми циклами, UI-системами и платформенными интеграциями.',
    'projects.storeContribution': 'Разрабатывал игровые циклы и UI-системы, интегрировал платформенные сервисы и готовил релизные сборки.',
    'skills.eyebrow': 'Технические навыки',
    'skills.title': 'Технологии и ключевые компетенции',
    ...
    'skills.networkText': 'Multiplayer, REST API, SignalR, WebSockets, Photon Fusion, Firebase, Adjust, Facebook SDK, Unity Analytics, Remote Config, Crashlytics, IAP, Localization.',
    'skills.deliveryTitle': 'Сборки, тестирование и инструменты',
    ...
    'experience.currentItem5': 'Автоматизировал сборку, публикацию, тестирование и распространение билдов, а также процессы code review и ClickUp с помощью TeamCity, Cloudflare R2, n8n, Discord и GitHub.',
    ...
    'experience.previousItem2': 'Реализовал чат, друзей, группы, облачные сохранения, рейтинги и задания с использованием REST API, SignalR и WebSockets.',
    'experience.previousItem3': 'Спроектировал переиспользуемые асинхронные сценарии для инфраструктуры приложения, навигации и сетевых функций.',
    ...
    'experience.previousItem5': 'Сократил размер сборки с 700 до 190 МБ и время загрузки сцен с 30 до 12 секунд; снизил нагрузку на RAM, CPU и GPU.',
