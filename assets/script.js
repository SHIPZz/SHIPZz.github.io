const translations = {
  en: {
    ...
    'metrics.years': 'years of commercial Unity development in production projects',
    'metrics.platforms': 'PC, console and Steam Deck development, through to mobile RPG projects',
    'metrics.optimization': 'build size, FPS stability, memory leaks and heavy performance bottlenecks',
    'metrics.ai': 'AI systems, internal tooling and assisted development workflows',
  ...
  ru: {
    ...
    'metrics.years': 'лет коммерческой Unity-разработки в production-проектах',
    'metrics.platforms': 'разработка для PC, консолей и Steam Deck, а также mobile RPG-проектов',
    'metrics.optimization': 'оптимизация билдов, FPS stability, memory leaks и тяжелых performance bottlenecks',
    'metrics.ai': 'AI-системы, internal tooling и assisted development workflows',
