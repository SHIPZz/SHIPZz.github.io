const translations = {
  en: {
    ...
    'cases.memoryResult': 'Menu memory fell from 2.8 GB to 1.3 GB, hub from 6 GB to 3 GB, and missions from 7-10 GB to 4.5-5.3 GB.',
  ...
  ru: {
    ...
    'hero.eyebrow': 'Senior Unity Developer',
    'hero.title': 'Kenan Ibragimov',
    'hero.text': 'Senior Unity Developer с опытом коммерческой разработки более 5 лет. Проектирую игровые, интерфейсные и мета-системы, занимаюсь оптимизацией, рендерингом, внутренними инструментами и автоматизацией билдов для ПК, консолей и мобильных платформ.',
    'hero.emailCta': 'Почта',
    ...
    'cases.memoryResult': 'Меню: с 2,8 до 1,3 ГБ; хаб: с 6 до 3 ГБ; миссии: с 7-10 до 4,5-5,3 ГБ.',
