const translations = {
  en: {
    ...
    'impact.loadTitle': 'Hub and mission loading',
    'impact.loadText': 'Reduced hub load time from 30s to 18s and mission load time from 47s to 23s by restructuring Addressables dependencies and deferring non-critical world initialization.',
    'impact.memoryTitle': 'Mission memory usage',
    ...
    'impact.fpsMetric': 'Combat performance stabilized',
    'impact.fpsTitle': 'Ability simulation and enemy turns',
    ...
    'impact.deliveryMetric': 'Automated build delivery',
    'impact.deliveryTitle': 'CI/CD and distribution',
  ...
  ru: {
    ...
    'impact.loadTitle': 'Загрузка хаба и миссий',
    'impact.loadText': 'Время загрузки хаба сокращено с 30 до 18 секунд, миссий - с 47 до 23 секунд за счёт переработки зависимостей Addressables и отложенной инициализации второстепенных объектов мира.',
    'impact.memoryTitle': 'Память миссий',
    ...
    'impact.fpsMetric': 'Производительность боя стабилизирована',
    'impact.fpsTitle': 'Симуляция абилок и ходы противника',
    ...
    'impact.deliveryTitle': 'CI/CD и дистрибуция',
