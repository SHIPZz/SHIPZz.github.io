const translations = {
  en: {
    ...
    'metrics.optimization': 'build size reduced from 23 GB to 12 GB through asset and pipeline work',
  ...
  ru: {
    ...
    'metrics.optimization': 'сокращение размера билда с 23 ГБ до 12 ГБ за счет asset и pipeline work',
